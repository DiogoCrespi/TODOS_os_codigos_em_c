...
int main() {
   ...
   // Excluir produtos (como no código original)
    int chaveExcluir1 = 6;
    int chaveExcluir2 = 10;
    int chaveExcluir3 = 4;
    ...
    printf("\n --- Excluindo os produtos de codigo %d, %d e %d --- \n", chaveExcluir1, chaveExcluir2, chaveExcluir3);
    int chaveExcluir[] = {chaveExcluir1, chaveExcluir2, chaveExcluir3};
    for (int i = 0; i < 3; i++) {
        printf("Excluindo chave %d...\n", chaveExcluir[i]);
        excluirInfoBTree(bTreeProduto, alocaInt(chaveExcluir[i]), comparaChaveProduto);
    }
